        ...
        <div class="result_wrap">
            <div class="result_content">
                <table class="list_tab">
                    ...
                    <tr>
                        <td class="tc">
                            <input type="text"  onchange="changeOrder(this,{{$c->cate_id}});" value="{{$c->cate_order}}">
                        </td>
                        <td class="tc">{{$c->cate_id}}</td>
                        <td>
                            <a href="#"><?php echo str_repeat("&nbsp;",$c->lev*3)?>{{$c->cate_name}}</a>
                        </td>
                        <td>
                            <a href="#">{{$c->cate_title}}</a>
                        </td>
                        <td>{{$c->cate_view}}</td>
                        <td>
                            <a href="{{url('admin/category/'.$c->cate_id.'/edit')}}">修改</a>
                            <a href="javascript:;" onclick="delCate({{$c->cate_id}});">删除</a>
                        </td>
                    </tr>
                    @endforeach
