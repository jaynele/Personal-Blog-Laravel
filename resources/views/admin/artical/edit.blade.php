...
@section('content')
    ...
    <div class="result_wrap">
        <form action="{{url('admin/artical/'.$field->art_id)}}" method="post">
            ...
            <table class="add_tab">
                <tbody>
                            ...
                            <select name="cate_id">
                                ...
                                <option value="{{$d->cate_id}}"
                                        @if($d->cate_id == $field->cate_id)
                                            selected
                                            @endif
                                        ><?php echo str_repeat("&nbsp;",$d->lev*3)?>{{$d->cate_name}}</option>
                                @endforeach
                            </select>
                    ...
                    <tr>
                        <th></th>
                        <td>
                            <img src="/{{$field->art_thumb}}" id="art_thumb_img" style="max-width: 300px;max-height: 200px;" alt="" />
                        </td>
                    </tr>
                    <tr>
                        <th>关键字：</th>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <script id="editor" type="text/plain" name="art_content" style="width:800px;height:200px;">{!!$field->art_content!!}</script>
                            <script type="text/javascript">
