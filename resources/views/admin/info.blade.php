...
@section('content')
	...
	<div class="crumb_warp">
		...
		<i class="fa fa-home"></i> <a href="#">首页</a> &raquo;  基本信息
	</div>
	<!--面包屑导航 结束-->
    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <ul>
                ...
                <li>
                    <label>上传附件限制</label><span><?php echo get_cfg_var('upload_max_filesize')?get_cfg_var('upload_max_filesize'):'文件太大不允许上传'?></span>
                </li>
                <li>
    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <ul>
                <li>
                    <label>官方交流网站：</label><span><a href="#">http://bbs.hou.com</a></span>
                </li>
                <li>
