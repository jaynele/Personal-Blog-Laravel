        ...
        <div class="result_wrap">
            <div class="result_content">
                <table class="list_tab">
                    ...
                    <tr>
                        <td class="tc">
                            <input type="text"  onchange="changeOrder(this,{{$c->nav_id}});" value="{{$c->nav_order}}">
                        </td>
                        <td class="tc">{{$c->nav_id}}</td>
                        <td>
                            <a href="#">{{$c->nav_name}}</a>
                        </td>
                        <td>
                            <a href="#">{{$c->nav_alias}}</a>
                        </td>
                        <td><a href="">{{$c->nav_url}}</a></td>
                        <td>
                            <a href="{{url('admin/navs/'.$c->nav_id.'/edit')}}">修改</a>
                            <a href="javascript:;" onclick="delnavs({{$c->nav_id}});">删除</a>
                        </td>
                    </tr>
                    @endforeach
                </table>
