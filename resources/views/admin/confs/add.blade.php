            ...
            <table class="add_tab">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="radio" name="field_type" checked value="input" onclick="getT();"/>input
                            <input type="radio" name="field_type" value="textarea" onclick="getT();"/>textarea
                            <input type="radio" name="field_type" value="radio" onclick="getT();"/>radio
                    ...
                    <tr  id="field_value">
                        ...
                        <td>
                            <input type="text" class="lg" name="field_value"><p>类型值只有在radio的情况下才需要配置,格式 1|开启, 0|关闭</p>
